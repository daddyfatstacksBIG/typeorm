...
and [Data Mapper](active-record-data-mapper.md#what-is-the-data-mapper-pattern)
...
any column type your database supports by implicitly specifying a column type
...
Column types are database-specific. You can set any column type your database
...
Once your entity is saved it will get a newly generated id. `save` method
